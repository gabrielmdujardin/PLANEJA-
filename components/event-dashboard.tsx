    ...
    <div className="container mx-auto max-w-6xl py-8 px-4">
      ...
      >
        <div>
          ...
          <p className="text-gray-600 dark:text-gray-300">Gerencie seus eventos e acompanhe as confirmações</p>
        </div>
                  ...
                  <Link href={`/event/${event.id}`}>
                    <EventCard
                      event={{
                        ...
                        // Esses valores seriam calculados com base nos convidados
                        confirmedGuests: 0,
                        totalGuests: 0,
                        // Esses arrays seriam preenchidos com dados do banco
                        items: [],
                        guests: [],
                      }}
                    />
